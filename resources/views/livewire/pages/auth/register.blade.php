 ...
 @if (Route::has('login'))
    ...
    <form wire:submit="register">
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="text-sm text-gray-600 underline rounded-md hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" href="{{ route('login') }}" wire:navigate>
                {{ __('Already registered?') }}
            </a>

            <x-button type="submit" primary class="font-bold ms-4">
                {{ __('Register') }}
            </x-button>
        </div>
    </form>
